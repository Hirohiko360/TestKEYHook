...
volatile int xOffset = 2; // 初始X轴偏移量
...
volatile int autoClickDelayBefore = 100; // 连点功能按下鼠标左键后的延迟
volatile int autoClickDelayAfter = 30; // 连点功能释放鼠标左键前的延迟
volatile int clickCount = 6; // 自定义点击次数
